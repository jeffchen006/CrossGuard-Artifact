...
class Crawler:
    ...
    def Contract2TxHistoryBlockIndex(self, contractAddress: str, endBlock: int = 999999999999999, startBlock: int = 0) -> list:
        """Given a contract address and an end block, return a list of (block, blockIndex) tuples"""
        ContractTxHistoryBlockIndex = None
        if endBlock == 999999999999999 and startBlock == 0:
            ContractTxHistoryBlockIndex = CrawlTrueBlocks().Contract2TxHistoryBlockIndex(contractAddress)
        else:
            ContractTxHistoryBlockIndex = self.crawlTrueBlocks.Contract2TxHistoryBlockIndex(contractAddress, (startBlock, endBlock))
